...
<div class="warp-content"> <!-- 主体内容 开始 -->
    <div class="info">
        <div class="bor">
            <p class="line-t-10"></p>
            <form id="installForm" name="installForm" action="<?=site_url('install.php?c=install&m=step4')?>" method="post">
                <fieldset class="fld">
                    <legend>数据库信息</legend>
                    <table>
                        <tbody>
                ...
                <p class="line-t-10"></p>
                <input type="hidden" id="url" value="<?=site_url('install.php?c=install&m=check')?>">
            </form>
        </div>
