<link rel="stylesheet" href="<!--{imageurl url=$tpl_path}-->css/common.css" type="text/css">
<script type="text/javascript" src="<!--{imageurl url=$tpl_path}-->js/jquery-1.7.2.min.js"></script>
<script type="text/javascript" src="<!--{imageurl url=$tpl_path}-->js/TouchSlide.1.1.js"></script>
<script>
